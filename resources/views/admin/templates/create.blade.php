    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('admin.templates.store') }}" class="p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="table_layout" rows="6" class="mt-1 border-gray-300 rounded-md text-sm w-full font-mono text-xs" placeholder='{"columns":[{"type":"row_number","label":"No","rowspan":2}]}'>{{ old('table_layout') }}</textarea>
            ...
            <div>
                ...
                <select onchange="window.location.href='{{ route('admin.templates.create') }}?source_import_id='+this.value" class="mt-1 border-gray-300 rounded-md text-sm w-full sm:w-auto">
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.templates.index') }}" class="px-4 py-2 bg-gray-100 text-gray-800 text-sm font-semibold rounded-md hover:bg-gray-200">Batal</a>
